...
contract HouseCouponToken is StandardToken, SafeMath {
    ...
    // contracts
    address public ethFundDeposit;          // deposit address for ETH for HCT Team.
    address public newContractAddr;         // the new contract for HCT token updates;
    ...
    {
        ethFundDeposit = 0xD1692d92e7bE5bAC0445C5649795054d4caB4529;
    ...
    /// @dev withdraw ETH from contract to HCT team address
